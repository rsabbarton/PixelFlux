...
//  #
//  #######################################################
export const FUNC_SET = 0;
export const FUNC_PAINT = 1;
export const FUNC_DARKEN = 2;
export const FUNC_LIGHTEN = 3;
export const FUNC_ERASE = 4;
...
export class PixelBrush {
  ...
  loadFromOpacityArray(width, height, name, opacityArray) {
    ...
    if (pixelCount != opacityArray.length) {
      console.log(
        "opacityArray not provided or does not contain correct number of pixels",
      );
